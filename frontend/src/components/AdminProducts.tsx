import { LayoutDashboard, Package, Users, LogOut, Plus, Search } from 'lucide-react';
          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody>
              <tr className="border-b border-gray-50">
                <td className="p-4">
                  <p className="font-medium text-gray-900">Classic Red Lipstick</p>
                  <p className="text-xs text-gray-500">SKU: LIP-001</p>
                </td>
                <td className="p-4 text-sm text-gray-600">Lipstick</td>
                <td className="p-4">
              ...
              <tr>
                <td className="p-4">
                  <p className="font-medium text-gray-900">Peach Nude Gloss</p>
                  <p className="text-xs text-gray-500">SKU: LIP-002</p>
                </td>
                <td className="p-4 text-sm text-gray-600">Lip Gloss</td>
                <td className="p-4">
                  <span className="bg-yellow-100 text-yellow-700 px-2 py-1 rounded text-xs font-medium">Low Stock</span>
                </td>
                <td className="p-4 text-sm">
                  <button className="text-primary-600 hover:underline mr-3">Edit</button>
                  <button className="text-rose-600 hover:underline">Delete</button>
